...
| [AutoMix & FIR Correctness](./analysis-fir-correctness.md) | Bounded head/tail interval ownership, metric scope, spectral cadence/tempo, explicit key capability, FIR design, and benchmark evidence. |
